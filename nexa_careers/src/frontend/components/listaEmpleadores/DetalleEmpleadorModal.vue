<template>
  <Transition name="fade">
    <div v-if="empleador" class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 px-4"
      ...
      <div class="bg-white rounded-3xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div class="p-8 space-y-6">
          ...
          <div v-if="empleador && !empleador.activo"
            ...
            <p class="text-gray-700 text-sm">
              ...
              {{ empleador.motivo_bloqueo || 'No se especificó un motivo.' }}
            </p>
            <p class="text-gray-500 text-xs mt-2 italic">
              Bloqueado el: {{ formatearFecha(empleador.fecha_bloqueo) }}
            </p>
          </div>
