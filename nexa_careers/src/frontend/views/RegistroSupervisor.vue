  ...
  <div class="min-h-screen bg-gradient-to-br from-[#0f172a] via-[#1e2937] to-[#0f172a] flex items-center justify-center p-6">
    <div class="w-full max-w-lg bg-white rounded-3xl shadow-2xl overflow-hidden">
      ...
      <div class="bg-[#1b2a4a] px-10 py-12 text-center">
        ...
        <h1 class="text-white text-3xl font-bold">Registro de Supervisor</h1>
        <p class="text-[#d0b06d] mt-2">Gestiona y supervisa la plataforma</p>
      </div>
        ...
        <form @submit.prevent="handleSubmit" class="space-y-6">
          <div class="grid grid-cols-2 gap-5">
            <div>
              ...
              <input v-model="form.nombre" type="text" class="mt-2 w-full px-5 py-4 bg-gray-50 border border-gray-200 rounded-2xl focus:border-[#b5943a]" />
            </div>
            <div>
              <label class="text-sm font-medium text-gray-600">Apellido</label>
              <input v-model="form.apellido" type="text" class="mt-2 w-full px-5 py-4 bg-gray-50 border border-gray-200 rounded-2xl focus:border-[#b5943a]" />
            </div>
          </div>

          <div>
            <label class="text-sm font-medium text-gray-600">Correo institucional (@ucb.edu.bo)</label>
            <input v-model="form.correo" type="email" class="mt-2 w-full px-5 py-4 bg-gray-50 border border-gray-200 rounded-2xl focus:border-[#b5943a]" />
          </div>
