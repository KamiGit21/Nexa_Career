...
const ofertasMock = [
  ...
  { oferta: 'Senior Data Analyst', descripcion: 'Lidera nuestros esfuerzos de análisis y toma de decisiones basadas en datos.', fecha_apertura: '2025-06-01', id_empleador: 2, modalidad: 'Virtual' },
  ...
  { oferta: 'UX/UI Designer', descripcion: 'Buscamos diseñador para asegurar la mejor experiencia. Se requiere portafolio.', fecha_apertura: '2025-06-25', id_empleador: 3, modalidad: 'Virtual' },
  ...
  { oferta: 'DevOps Engineer', descripcion: 'Optimiza nuestra infraestructura y flujos de trabajo de CI/CD. Excelentes beneficios.', fecha_apertura: '2025-07-18', id_empleador: 1, modalidad: 'Virtual' },
  ...
  { oferta: 'Sales Executive', descripcion: 'Identifica oportunidades de mercado y define la hoja de ruta de ventas.', fecha_apertura: '2025-08-11', id_empleador: 3, modalidad: 'Virtual' },
  ...
  { oferta: 'Copywriter', descripcion: 'Crea contenido atractivo para nuestro sitio web, blog y redes sociales.', fecha_apertura: '2025-09-09', id_empleador: 2, modalidad: 'Virtual' },
  ...
  { oferta: 'Full Stack Engineer', descripcion: 'Construye y mantén nuestra aplicación web utilizando tecnologías modernas.', fecha_apertura: '2025-10-01', id_empleador: 2, modalidad: 'Virtual' },
  ...
  { oferta: 'Content Strategist', descripcion: 'Desarrolla y ejecuta nuestra estrategia de contenido para aumentar el tráfico.', fecha_apertura: '2025-10-25', id_empleador: 2, modalidad: 'Virtual' },
  ...
  { oferta: 'Business Development Rep', descripcion: 'Únete a nuestro equipo de ventas y genera nuevos leads calificados.', fecha_apertura: '2025-11-08', id_empleador: 1, modalidad: 'Virtual' },
  ...
  { oferta: 'Customer Success Lead', descripcion: 'Gestiona nuestro equipo de éxito del cliente y aumenta la retención.', fecha_apertura: '2025-12-01', id_empleador: 1, modalidad: 'Virtual' },
  ...
  { oferta: 'Legal Counsel', descripcion: 'Asesoramiento legal para contratos corporativos y cumplimiento normativo.', fecha_apertura: '2025-12-23', id_empleador: 2, modalidad: 'Virtual' },
  ...
  { oferta: 'Operations Lead', descripcion: 'Asegura la seguridad y eficiencia de las operaciones en planta.', fecha_apertura: '2026-02-01', id_empleador: 3, modalidad: 'Virtual' },
  ...
  { oferta: 'Social Media Manager', descripcion: 'Usa datos y análisis para impulsar campañas en líneas de productos innovadoras.', fecha_apertura: '2026-02-23', id_empleador: 2, modalidad: 'Virtual' },
  ...
  { oferta: 'Cloud Computing Intern', descripcion: 'Obtén experiencia práctica en computación en la nube y análisis de datos.', fecha_apertura: '2026-03-16', id_empleador: 1, modalidad: 'Virtual' },
  ...
  { oferta: 'Content Writer', descripcion: 'Comparte nuestra historia y conecta con clientes a través de artículos.', fecha_apertura: '2026-04-01', id_empleador: 2, modalidad: 'Virtual' },
  ...
  { oferta: 'Junior Accountant', descripcion: 'Apoya a nuestro equipo financiero, prepara estados financieros y reportes.', fecha_apertura: '2026-04-23', id_empleador: 2, modalidad: 'Virtual' },
  ...
  { oferta: 'Technician I', descripcion: '¿Eres un técnico hábil? Únete para mantener nuestra tecnología funcionando.', fecha_apertura: '2026-05-23', id_empleador: 3, modalidad: 'Virtual' },
  ...
  { oferta: 'QA Automation Tester', descripcion: 'Automatiza procesos de prueba y asegura la fiabilidad de nuestros productos.', fecha_apertura: '2026-06-08', id_empleador: 2, modalidad: 'Virtual' },
  ...
  { oferta: 'Lead Java Developer', descripcion: 'Desarrollador Java Senior para liderar el equipo de arquitectura de microservicios.', fecha_apertura: '2026-07-01', id_empleador: 3, modalidad: 'Virtual' },
  ...
  { oferta: 'Junior Marketing Manager', descripcion: 'Crea y ejecuta campañas multicanal con enfoque en métricas de conversión.', fecha_apertura: '2026-07-23', id_empleador: 2, modalidad: 'Virtual' },
  ...
  { oferta: 'Especialista en Ciberseguridad', descripcion: 'Protege nuestra infraestructura de red y datos confidenciales contra amenazas.', fecha_apertura: '2026-08-15', id_empleador: 1, modalidad: 'Virtual' },
  { oferta: 'Desarrollador iOS Senior', descripcion: 'Construye la próxima generación de nuestra aplicación móvil insignia para Apple.', fecha_apertura: '2026-08-22', id_empleador: 2, modalidad: 'Virtual' },
  ...
  { oferta: 'Traductor Técnico', descripcion: 'Traduce manuales y documentación técnica de software del inglés al español.', fecha_apertura: '2026-09-19', id_empleador: 3, modalidad: 'Virtual' },
  ...
  { oferta: 'Asesor de Ventas B2B', descripcion: 'Venta de soluciones tecnológicas a nivel corporativo con atractivas comisiones.', fecha_apertura: '2026-10-10', id_empleador: 3, modalidad: 'Virtual' },
  ...
  { oferta: 'Auditor de Calidad ISO', descripcion: 'Asegura el cumplimiento de las normativas de calidad ISO 9001 en los procesos.', fecha_apertura: '2026-10-31', id_empleador: 3, modalidad: 'Virtual' },
